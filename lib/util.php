...
class OC_Kubernetes_Util {
  ...
  public static function createPod($yaml_file, $uid)
  {
	$complete_uri = OC_Kubernetes_Util::$URI."run_pod.php?user_id=".$uid."&storage_path=www&public_key=ssh-rsa&yaml_uri=/files/pod_manifests/".$yaml_file;
	$response = file_get_contents($complete_uri);
